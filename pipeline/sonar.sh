...
./node_modules/sonar-scanner/bin/sonar-scanner -Dsonar.login=admin -Dsonar.password=admin -Dsonar.host.url=http://democluster-team1-sonarqube-sonarqube.democluster-team1.svc.cluster.local:9000
